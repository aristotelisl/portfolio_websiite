  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex-col gap-3 text-slate-500'>
        <p>
          Some of my favourite personal and university projects of the past year. Have a look below!
        </p>
      </div>
              ...
              <div className='mt-5 flex items-center gap-2 font-poppins'>
                ...
                >
                  <div className='flex items-center'>
                    Link
                    <img src={github} alt="github" className='w-4 h-4 object-contain ml-1'/>
                  </div>
                </Link>
