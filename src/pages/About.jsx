  ...
  return (
    <section className='max-container'>
      <h1 className='head-text'>
        Hello, I'm <span className='blue-gradient_text font-semibold drop-shadow'>Aristotelis</span>
      </h1>
      ...
      <div className='mt-5 flex-col gap-3 text-slate-500'>
        <p>
          ...
          Interested in building applications and learning new technologies. Currently seeking employment as a Junior Software Engineer.
        </p>
      </div>
